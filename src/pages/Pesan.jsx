                    ...
                    <tr key={msg.id_pesan || index}>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          ...
                          <button className="btn btn-sm btn-outline-danger border-0 p-1" onClick={() => handleDelete(msg.id_pesan)} title="Hapus">
                            <Trash2 size={18} />
                          </button>
                        </div>
                      </td>
        ...
        <div className={`modal-overlay-custom ${isModalOpen ? 'open' : ''}`} onClick={handleCloseModal}>
          <div className="modal-content-custom" onClick={(e) => e.stopPropagation()}>
            <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
              ...
              <button className="btn btn-link text-dark p-0" onClick={handleCloseModal}><X size={24} /></button>
            </div>
                ...
                <div className="row mb-3">
                   <div className="col-md-6">
                    ...
                    <div className="detail-value d-flex align-items-center gap-2">
                      <Tag size={16} className="text-muted"/> {selectedMessage.layanan_pesan}
                    </div>
                  </div>
                  <div className="col-md-6">
