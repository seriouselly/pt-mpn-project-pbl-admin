...
export default function AdminPage() {
  ...
  const handleSubmit = async () => {
    if (!form.name || !form.email || !form.password || !form.telp) {
    ...
    try {
      ...
      setShowModal(false);
      setForm({ name: "", email: "", password: "", telp: "" });
      loadUsers();
    } catch (error) {
      console.error(error);
      toast.error(error.response?.data?.errors || "Gagal menambah admin");
    }
  };
      ...
      <div className="page-container">
            ...
            <table className="table table-hover mb-0">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan="4" className="text-center p-4">Belum ada data admin lain.</td></tr>
                ) : (
                  users.map((u) => (
                    <tr key={u.id}>
        ...
        <ModalItem
          ...
          fields={[
            ...
            { name: "password", label: "Password Default", type: "text" }, // Sebaiknya type password, tapi text biar admin tau apa yg diketik
