...
import { Eye, Trash2, Pen, Plus, Search, GraduationCap } from "lucide-react";
...
export default function Pelatihan() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Map Pelatihan
      const rawPelatihan = Array.isArray(resPelatihan)
        ? resPelatihan
        : resPelatihan.data || [];
      ...
      const rawLayanan = Array.isArray(resLayanan)
        ? resLayanan
        : resLayanan.data || [];
                        ...
                        <td>
                          <div className="d-flex justify-content-center gap-2">
                            <Button
                              ...
                              size="sm"
                              onClick={() => handleShowModal("view", item)}
                            >
                              <Eye size={16} />
                            </Button>
                            <Button
        ...
        <ModalPelatihan
          ...
          fields={[
            { name: "nama", label: "Nama Pelatihan", type: "text" },
            {
              ...
              type: "select",
              options: layananList.map((l) => l.nama_BUsaha),
            },
            {
              name: "deskripsi",
              label: "Deskripsi",
